...
const Manager = () => {
    ...
    const savePassword = () => {
        if (form.site.length > 3 && form.username.length > 3 && form.password.length > 3) {
            ...
            toast.error('Error: Fields are required before saving the passwords!🦄', {
                position: "top-right",
                autoClose: 3000,
                hideProgressBar: false,
                closeOnClick: true,
        ...
        <>
            ...
            <div className="p-2 md:p-0 md:mycontainer min-h-[88.2vh]">
                ...
                <div className="passwords">
                    <h2 className="font-bold text-2xl text-green-400 py-4">
                        Your Passwords
                    </h2>
                        ...
                        <table className="table-auto w-full rounded-md overflow-hidden mb-10">
                            ...
                            <tbody className="bg-green-100">
                                {passwordArray.map((item, index) => {
                                    return (
                                        <tr key={index}>
                                            <td className=" py-2 border border-green-200 text-center">
                                                <div className="flex justify-center items-center">
                                                    ...
                                                    <div className="lordicon size-7 cursor-pointer" onClick={() => { copyText(item.site) }}>
                                                        <img
                                                            style={{ "width": "20px", "height": "25px", "paddingTop": "5px" }}
                                                            src="/icons/kaapi.gif"
                                                            alt="copy"
                                                        />
                                                    </div>
                                            ...
                                            <td className=" flex items-center justify-center py-2 border border-green-200 text-center">
                                                <span className="cursor-pointer mx-1" onClick={() => { editPassword(item.id) }}>
                                                    <img style={{ "width": "20px", "height": "25px", "paddingTop": "5px", }} src="/icons/pencil.gif" trigger="hover" alt="edit" />
                                                </span>
